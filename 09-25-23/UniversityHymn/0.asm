...
.stack
.data
ParagraphOne db 0dh, 0ah, "IN A HIGH-TECH SCHOOL", 0dh, 0ah, "THAT'S WHERE WE'VE BEEN HERE IN DAGUPAN", 0dh, 0ah, "HEY! WE WON'T FORGET", 0dh, 0ah, "OUR FRIENDS ARE HERE(SEMICOLON HERE) OUR MENTORS TOO", 0dh, 0ah, "SO RALLY ON, LET'S GET THERE SOON", 0dh, 0ah, "OUR DEAR SCHOOL WILL WELCOME US BACK", 0dh, 0ah, "WE'LL NOT REGRET, MY FRIENDS", 0dh, 0ah, "OUR SCHOOL IS YET THE BEST", 0dh, 0ah, "WE'RE SURE OF THIS AND MORE$"
